    ...
    <div class="main_container">
        <div class="sidebar">
            <div class="sidebar__inner">
                <div class="profile">
                    <div class="img">
                        <img src="../img/user1.png" alt="profile_pic">
                    </div>
                ...
                <ul>
                    <li>
                        <a href="#container" onclick="includeHTMLPHPFile('ActualizarPerfilPaciente.php','container');">
                            <span class="icon"><i class="fas fa-address-card"></i></span>
                            <span class="title">Perfil</span>
                        </a>
                    </li>
                    <li>
                        <a href="#container" onclick="includeHTMLPHPFile('PaginaAcceso.php','container');">
                            <span class="icon"><i class="fas fa-book-medical"></i></span>
                            <span class="title">Agendar cita</span>
                        </a>
                    </li>
                    <li>
                        <a href="#container" onclick="includeHTMLPHPFile('ListarCitasPaciente.php','container');">
